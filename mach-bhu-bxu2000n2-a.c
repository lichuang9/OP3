...
#define BHU_BXU2000N2_A1_GPIO_LED_WAN		20
#define BHU_BXU2000N2_A1_GPIO_LED_LAN		22
#define BHU_BXU2000N2_A1_GPIO_LED_S0		14
#define BHU_BXU2000N2_A1_GPIO_LED_S1		19
#define BHU_BXU2000N2_A1_GPIO_LED_S2		15
#define BHU_BXU2000N2_A1_GPIO_LED_S3		21
...
static struct gpio_led bhu_bxu2000n2_a1_leds_gpio[] __initdata = {
	{
		...
		.name		= "bhu:green:s0",
		.gpio		= BHU_BXU2000N2_A1_GPIO_LED_S0,
		.active_low	= 1,
	}, {
		.name		= "bhu:green:s1",
		.gpio		= BHU_BXU2000N2_A1_GPIO_LED_S1,
		.active_low	= 1,
	}, {
		.name		= "bhu:green:s2",
		.gpio		= BHU_BXU2000N2_A1_GPIO_LED_S2,
		.active_low	= 1,
	}, {
		.name		= "bhu:green:s3",
		.gpio		= BHU_BXU2000N2_A1_GPIO_LED_S3,
		.active_low	= 1,
	},
};
